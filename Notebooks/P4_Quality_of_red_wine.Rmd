...
ggplot(data=rw) + 
  geom_histogram(aes(x=factor(predRounded),binwidth=1),
                 fill = "black",
                 alpha = 0.5) +
  geom_histogram(aes(x=factor(quality)),
                 binwidth = 1,
                 fill = "red",
                 alpha = 0.5) + 
...
ggplot(data=rw) + 
  geom_histogram(aes(x=factor(diffive)),
                 fill="blue",
                 alpha=0.8)+
  geom_histogram(aes(x=factor(diff)),
                 fill="red",
                 alpha=0.8)+
